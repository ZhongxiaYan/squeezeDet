...
class SqueezeDetPlus(ModelSkeleton):
    ...
    def _add_forward_graph(self):
        ...
        fire8 = self._fire_layer('fire8', fire7, s1x1=384, e1x1=256, e3x3=128, freeze=False)
        pool8 = self._pooling_layer('pool8', fire8, size=3, stride=2, padding='VALID')

        fire9 = self._fire_layer('fire9', pool8, s1x1=384, e1x1=256, e3x3=128, freeze=False)

        # Two extra fire modules that are not trained before
        fire10 = self._fire_layer('fire10', fire9, s1x1=384, e1x1=256, e3x3=128, freeze=False)
        fire11 = self._fire_layer('fire11', fire10, s1x1=384, e1x1=256, e3x3=128, freeze=False)
